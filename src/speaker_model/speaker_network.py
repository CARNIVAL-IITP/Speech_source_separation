...
class ECAPA_TDNN(nn.Module):
    ...
    def __init__(self, C):
        ...
        D = 128
        self.layer4 = nn.Conv1d(3 * C, D, kernel_size=1)
        self.attention = nn.Sequential(
            nn.Conv1d(D*3, 256, kernel_size=1),
            nn.ReLU(),
            nn.BatchNorm1d(256),
        ...
        self.bn5 = nn.BatchNorm1d(D*2)
        self.fc6 = nn.Linear(D*2, 192)
...
if __name__ == '__main__':
    ...
    speaker_embedding = model(wav,aug=False)
    # loss_func = AAMsoftmax(10,0.2,30)
    # tmp = loss_func(speaker_embedding)
    print("")
