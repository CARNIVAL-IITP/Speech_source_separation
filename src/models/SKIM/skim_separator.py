...
import sys
sys.path.append("/home/bjwoo/PycharmProjects/espnet")
...
class SkiMSeparator(AbsSeparator):
    ...
    def __init__(
        ...
        if nonlinear not in ("sigmoid", "relu", "tanh","gelu"):
    ...
    def forward(
        ...
        processed = processed.reshape(B, T, N, self.num_outputs)
